...
//   * @param vehicleEntrantPaymentRepository An instance of {@link CazEntrantPaymentRepository}.
//   */
...
//        payment.getCazEntrantPayments().stream()
//            .map(cazEntrantPayment -> updateWithPaymentId(cazEntrantPayment, paymentId))
//            .collect(Collectors.toList());
//
//    List<CazEntrantPayment> cazEntrantPaymentsWithIds =
//        vehicleEntrantPaymentRepository.insert(cazEntrantPayments);
//
//    return payment.toBuilder().id(paymentId).vehicleEntrantPayments(cazEntrantPaymentsWithIds)
//        .build();
//    return Payment.builder().id(UUID.randomUUID()).build();
//  }
//
//  /**
...
//   *
//   * @return A list of {@link Payment} which were done in GOV UK Pay service, but were
//   * not finished.
//   */
...
//   */
//  private CazEntrantPayment updateWithPaymentId(CazEntrantPayment vehicleEntrantPayment,
//      UUID paymentId) {
