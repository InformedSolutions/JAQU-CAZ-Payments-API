INSERT INTO caz_payment.t_payment(
	payment_id, user_id, payment_method, payment_provider_id, total_paid, payment_provider_status, payment_submitted_timestamp, payment_authorised_timestamp, operator_id)
	VALUES
	  ('b71b72a5-902f-4a16-a91d-1a4463b801db', 'ab3e9f4b-4076-4154-b6dd-97c5d4800b47', 'CREDIT_DEBIT_CARD', 'provider_1_test', 100, 'SUCCESS', now(), now(), 'd47bcc60-dafc-11ea-87d0-0242ac130003'),
	  ('dabc1391-ff31-427a-8000-69037deb2d3a', '88732cca-a5c7-4ad6-a60d-7edede935915', 'CREDIT_DEBIT_CARD', 'provider_2_test', 100, 'SUCCESS', now() - interval '1 hour', now(), 'd47bce5e-dafc-11ea-87d0-0242ac130003'),
	  ('dabc1391-ff31-427a-8000-69037deb2d3b', '88732cca-a5c7-4ad6-a60d-7edede935915', 'CREDIT_DEBIT_CARD', 'provider_3_test', 100, 'SUCCESS', now(), now(), 'd47bce5e-dafc-11ea-87d0-0242ac130004');
