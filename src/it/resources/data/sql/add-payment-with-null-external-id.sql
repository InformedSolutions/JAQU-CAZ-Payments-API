...
insert into caz_payment.t_clean_air_zone_entrant_payment(travel_date, clean_air_zone_id, vrn, payment_status, charge)
values
(now(), 'b8e53786-c5ca-426a-a701-b14ee74857d4', 'ND84VSX', 'NOT_PAID', 100);