INSERT INTO caz_payment.t_payment(
	...
	VALUES
	  ('b71b72a5-902f-4a16-a91d-1a4463b801db', 'CREDIT_DEBIT_CARD', '12345test', 4200, 'SUCCESS', now(), now());
...
INSERT INTO caz_payment.t_clean_air_zone_entrant_payment(
	...
	VALUES
	  ('9cc2dd1a-905e-4eaf-af85-0b14f95aab89', 'ND84VSX', '53e03a28-0627-11ea-9511-ffaaee87e375', '2019-11-02', 'tariff-one', 2100, 'PAID', 'USER'),
	  ('303221c8-3871-11ea-9691-7387f945f3a5', 'ND84VSX', '53e03a28-0627-11ea-9511-ffaaee87e375', '2019-11-10', 'tariff-two', 2100, 'PAID', 'USER');
